...
exports.gamedata = {'categories': ['The Heart of jQueriness by J. Conrad', 'Keeping Accessibility In Easy Reach', 'Things Homer Never Told Us About Ajax',
	    ...
	    'qadata': {'id0x0': ['Methods in the $ namespace.' , 'What are core jQuery methods?'],
		       ...
		       'id1x3': ['This says to ensure the web site is fully functional using only the keyboard.', 'What is the MSU Web accessibility policy?'],
		       'id1x4': ['This says to ensure scripts work with assistive devices.', 'What is the MSU Web accessibility policy?'],
